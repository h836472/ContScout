This folder contains a collection of demo data to test ContScout. *Database.tar.gz* holds a small-scale pre-formatted reference database set while *query.tar.gz* contains a test query data.  
