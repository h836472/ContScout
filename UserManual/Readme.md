...
>singularity exec -B /data/CS_test/local_database/database:/database -B /data/CS_test/query:/query -B /tmp:/cs_temp /data/CS_test/singularity_images/contscout_latest.sif ContScout -u /database -i /query -q 58331 -c 2 -x all -p 20 -t CS_temp  
